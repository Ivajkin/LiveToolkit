...
####Общие требования
Обеспечение надёжной защиты слоя и единства с основным приложением. Другими словами, элементы слоя нельзя запустить вне LivePlatform, по крайней мере пользователю. 
####Lessons (Уроки)
...
####Interactive Exercises (Интерактивные упражнения)
