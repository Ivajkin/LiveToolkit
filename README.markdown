...
Другой вариант -- использовать архитектуру клиент-сервер. В этом случае упражнение-клиент булет передавать даннные на форму LivePlatform-серверу. Эти данные можно использовать для отрисовки упражнения в определённой форме в LivePlatform.
####6. Videos (Видеоуроки)
...
Если рассмотреть таблицы группы *А* и таблицу *Elements*, то станет ясно, что связи между *Elements* и *Books*, *Elements* и *Intearactive_Exercises* лишние. Фактически эти связи используются для доступа к интерактивным упражнениям и книгам напрямую, как к элементам слоя. Эти связи поддерживают семантический смысл слоя в БД -- показатель наличия элементов и навигау=ция по элементам через интерфейс слоёв.
...
##То о чём у нас не принято говорить
...
Это важная часть пособия, особенно потому как в учебникех по восточным языка такого деления не проводится. Если мы реализуем ДЕ -- большой плюч нам будет. В большей степени это зависит от лингвиста-составителя учебника.
