...
БД напоминает солнышко -- в центре находится таблица Elements, в которой все элементы являются внешними ключами. И её "лучи" в виде связей направлены к ключевым полям других таблиц. Всей этой идилии мешает пара связей между Lessons и Books, Lessons и Interactive Exercises. Эти свчзи показывает зависимость интерактивных упражнений и книг от уроков.
