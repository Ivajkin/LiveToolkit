...
В каждом разделе редактора нужен элемент для просмотра. При нажаии на кнопку !["Просмотр"](http://cdn1.iconfinder.com/data/icons/WPZOOM_Developer_Icon_Set/32/eye.png), открывается отдельное окно с работающим упражнением.
